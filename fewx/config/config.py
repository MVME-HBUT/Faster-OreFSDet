...
def get_cfg() -> CN:
    ...
    # _C.MODEL.CENTERNET.IN_FEATURES = ["res4"]
    ...
    _C.MODEL.CENTERNET.SOI = [[0, 80], [64, 160], [128, 320]] #[[0, 80], [64, 160], [128, 320], [256, 640], [512, 10000000]]
    ...
    # _C.MODEL.ROI_HEADS.IOU_THRESHOLDS = [0.6, 0.7, 0.8]
    # _C.MODEL.ROI_BOX_HEAD.POOLER_RESOLUTION1= 2
    _C.MODEL.ROI_BOX_HEAD.POOLER_RESOLUTION2= 4
